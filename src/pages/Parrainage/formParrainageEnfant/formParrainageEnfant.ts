...
export class FormParrainageEnfantPage implements OnInit, OnDestroy {
  ...
  onSubmitForm() {
    ...
    if (password === password2) {
      this.utilisateur = new Utilisateur(this.utilisateurService.utilisateurList.length + 1, prenom, nom, adresse, profession, telephone, "", "", email, password, "parrain");
      ...
      this.navCtrl.push(ConfirmationParrainagePage,{filleul:this.filleul, dons:don});
